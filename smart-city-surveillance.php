 ...
 <link rel="stylesheet" href="assets\css\smart-city-surveillance.css">
 ...
 <div id="main-wrapper">
     <div class="site-wrapper-reveal">
         ...
         <section class="xp-telecom-section">
             <div class="container">
                 <div class="xp-telecom-header" data-aos="fade-up">
                     <span class="xp-badge">Smart City & Surveillance</span>
                     <h2 class="xp-title">Smart City & <span class="text-highlight">Surveillance Platform</span></h2>
                     <p class="xp-subtitle">
                         As cities, campuses, and critical infrastructure grow in complexity, the need for intelligent,
                         integrated surveillance and public safety systems has never been greater. Xpansion Technologies
                         delivers end-to-end Smart City and Surveillance solutions — combining AI-powered video
                         analytics, ANPR, real-time data platforms, and command centre technology into a unified,
                         scalable framework that drives safer, more efficient urban and enterprise environments.
                     </p>
                 </div>
                 ...
                 <div class="row align-items-center mt-5" data-aos="fade-right">
                     <div class="col-lg-5 col-md-12">
                         <div class="xp-image-wrapper">
                             <img src="assets\images\4.png" class="w-100 xp-main-img" alt="Telecom Services">
                             <div class="xp-floating-card">
                                 <i class="fas fa-signal"></i>
                                 <span>Private 5G Ready</span>
                             </div>
                         </div>
                     </div>
                     ...
                     <div class="col-lg-7 col-md-12" data-aos="fade-left">
                         <div class="xp-services-grid">
                             ...
                             <div class="xp-service-card">
                                 ...
                                 <div class="xp-card-content">
                                     <h3>Centralised Command & Control</h3>
                                     <p>Unified operations centres integrating feeds from cameras, sensors, ANPR, and
                                         IoT
                                         devices into a single, real-time command interface.</p>
                                 </div>
                             </div>
                             ...
                             <div class="xp-service-card">
                                 ...
                                 <div class="xp-card-content">
                                     <h3>ANPR & Traffic Intelligence</h3>
                                     <p>Automatic Number Plate Recognition systems for law enforcement, traffic
                                         management, parking enforcement, and access control.</p>
                                 </div>
                             </div>
