    ...
    <section class="xp-telecom-section pb-0">
        <div class="container">
            <div class="xp-telecom-header" data-aos="fade-up">
                ...
                <h2 class="xp-title">Enterprise-Grade Connectivity for <span class="text-highlight">Modern
                        Organisations</span></h2>
                <p class="xp-subtitle">
                    Xpansion Technology delivers purpose-built telecom solutions for organisations that demand reliable,
                    secure, and high-performance networks. We plan, design, deploy, and support connectivity
                    infrastructure — giving your organisation enterprise-grade capability without unnecessary
                    complexity.
                </p>
            </div>
            ...
            <div class="row align-items-center mt-5" data-aos="fade-right">
                <div class="col-lg-5 col-md-12">
                    <div class="xp-image-wrapper">
                        <img src="assets/images/telecom-services.jpg" class="w-100 xp-main-img" alt="Telecom Services">
                    ...
                    <div class="xp-services-grid">
                        <div class="xp-service-card">
                            ...
                            <div class="xp-card-content">
                                ...
                                <p>Flexible and scalable connectivity options designed to match your organisation's
                        ...
                        <div class="xp-service-card">
                            ...
                            <div class="xp-card-content">
                                ...
                                <p>One partner across planning, design, deployment, and ongoing managed support — no
                                    handoffs, no gaps.</p>
                            </div>
                        </div>
                        ...
                        <div class="xp-service-card">
                            ...
                            <div class="xp-card-content">
                                <h3>Wide Coverage</h3>
                                <p>IoT SIMs and network services with broad geographic coverage across metro, regional,
                                    and remote sites.</p>
                            </div>
                        </div>
                        ...
                        <div class="xp-service-card">
                            ...
                            <div class="xp-card-content">
                                ...
                                <p>Modern network designs built for growth, IoT scale, and integration with cloud and AI
                                    platforms.</p>
                            </div>
                        </div>
                    </div>
