                        ...
                        <form method="post" action="blog_insert.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <textarea name="blog_point_one" id="blog_point_one" class="form-control" type="text"
                                        name="" placeholder="Enter Blog Meta Kewords.."></textarea>
                                </div>
                                <div class="col-sm-6 form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input class="form-control" type="text" name="blog_point_two"
                                        placeholder="Enter image name">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Choose Multiple Images</label>
                                    <input class="form-control" type="file" name="logos[]" accept="image/*" multiple required>
                                </div>
                            </div>
                            <div class="row">
